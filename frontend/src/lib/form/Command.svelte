<script>
    ...
    let command = writable(entry.command);
...
<div>
    ...
    <div class="mb-4">
        ...
        <input bind:value={entry.command} class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" id="command" type="text" placeholder="npm install">
    </div>
</div>